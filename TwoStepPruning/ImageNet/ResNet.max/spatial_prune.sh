...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main.py --pretrained saved_models/checkpoint.prune.1.pth.tar --prune --winograd-structured --lr 0.01 --epochs 60 --percentage 0.4 --stage 2 &> step2
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main.py --pretrained saved_models/checkpoint.prune.3.pth.tar --prune --winograd-structured --lr 0.01 --epochs 60 --percentage 0.55 --stage 4 &> step4
