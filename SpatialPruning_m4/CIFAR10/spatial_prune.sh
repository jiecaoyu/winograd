...
python main.py --pretrained saved_models/vgg_nagadomi.best_origin.pth.tar --prune --winograd-structured --lr 0.001  --epochs 250 --percentage 0.2  --stage 0 &> step0
python main.py --pretrained saved_models/vgg_nagadomi.prune.0.pth.tar     --prune --winograd-structured --lr 0.001  --epochs 250 --percentage 0.3  --stage 1 &> step1
python main.py --pretrained saved_models/vgg_nagadomi.prune.1.pth.tar     --prune --winograd-structured --lr 0.001  --epochs 250 --percentage 0.4  --stage 2 &> step2
